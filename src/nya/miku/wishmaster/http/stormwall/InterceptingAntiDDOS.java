...
import nya.miku.wishmaster.http.cloudflare.CloudflareChecker;
...
/*package*/ class InterceptingAntiDDOS {
    ...
    public Cookie check(final StormwallException exception, final ExtendedHttpClient httpClient, final CancellableTask task, final Activity activity) {
        synchronized (lock) {
        ...
        StormwallChecker.removeCookie(cookieStore, exception.getRequiredCookieName());
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
                ...
                try {
                    ...
                    for (Cookie cookie : cookieStore.getCookies()) {
                        if (StormwallChecker.isSWPCookie(cookie, url, exception.getRequiredCookieName())) {
