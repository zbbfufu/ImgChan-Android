...
public class StormwallRecaptchaUIHandler {
     ...
     * @param e исключение {@link StormwallExceptionRecaptcha}
     ...
     */
    static void handleStormwall(final StormwallExceptionRecaptcha e, final HttpChanModule chan, final Activity activity, final CancellableTask cfTask,
                    ...
                    public void onSuccess() {
                        Async.runAsync(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Cookie swpCookie = StormwallRecaptchaChecker.getInstance().
