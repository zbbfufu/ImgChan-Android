...
public class StormwallRecaptchaChecker {
    private static final String TAG = "StormwallRecaptchaChecker";
    
    private StormwallRecaptchaChecker() {}
    private static StormwallRecaptchaChecker instance;
    
    /** Получить объект-синглтон */
    public static synchronized StormwallRecaptchaChecker getInstance() {
        if (instance == null) instance = new StormwallRecaptchaChecker();
        return instance;
    }
     ...
     */
    public Cookie checkRecaptcha(StormwallExceptionRecaptcha exception, ExtendedHttpClient httpClient, CancellableTask task, String recaptchaAnswer) {
